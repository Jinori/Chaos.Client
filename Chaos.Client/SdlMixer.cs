...
///     linux-x64 .so MUST be the self-contained build produced by tools/build-sdl2-mixer-linux.sh; a distro
///     package build DT_NEEDED-links system codec libs (libmpg123/libFLAC/...) and yields no audio without them.
/// </summary>
